...
EQUIPMENT = [
    ...
    ("Торцовочная пила Makita LS0714N", 1, 49607, "Все инструменты", "grant"),
    ("Фрезер DeWalt D 26204 K", 1, 55900, "Все инструменты", "grant"),
    ("Кромочный фрезер Makita RT0702CX2", 1, 22490, "Все инструменты", "grant"),
    ("Пила дисковая погружная Makita SP6000", 1, 42347, "Все инструменты", "grant"),
    ("Строительный пылесос Karcher WD 6 P S", 1, 29993, "Все инструменты", "grant"),
    ("Шаблон врезки петель и замков «Платинум» Павла Солдатова", 1, 22260, "Все инструменты", "grant"),
    ("Лазерный нивелир Bosch UniversalLevel 2", 1, 14482, "Все инструменты", "grant"),
    ("Гвоздезабиватель аккумуляторный Ryobi R16GN18-0 ONE+", 1, 22466, "Все инструменты", "grant"),
    ("Компрессор аккумуляторный Makita MP100DZ", 1, 7307, "Все инструменты", "grant"),
    ("Верстак складной Pony Jorgensen 2-в-1", 1, 19750, "Все инструменты", "grant"),
    ("Многофункциональный инструмент DeWalt DCS356N-XJ", 1, 24037, "Все инструменты", "grant"),
    ("Комплект аккумуляторов и зарядных устройств (Ryobi 18 В 2.0 А·ч, Makita 12 В 2.6 А·ч, DeWalt DCB184 18 В 5.0 А·ч)", 1, 16081, "Все инструменты", "grant"),
    ("Комплект пильных дисков CMT (по металлу/алюминию 250×30 и по дереву 254×30)", 1, 21231, "Все инструменты", "grant"),
    ("Костюм рабочий «СОЮЗСПЕЦОДЕЖДА STATUS NEW»", 1, 7652, "Все инструменты", "mixed"),  # переходная
    ("Стартовый запас расходников (монтажная пена, метизы, анкера, монтажный клей, наличники и доборы для образцов)", 1, 10000, "Леруа Мерлен", "own"),
]
...
SERVICES = [
    ...
    ("Установка раздвижной межкомнатной системы (дверь-купе): монтаж верхней направляющей, навеска полотна на ролики, регулировка хода и доводчика",
     "Установка раздвижной системы (дверь-купе)", "3 часа", 3500,
...
# ТИТУЛ
set_para_text(by_idx(17), "Проект «Профессиональная установка межкомнатных дверных блоков, монтаж скрытых дверных систем Invisible, раздвижных дверей-купе и теневых алюминиевых плинтусов»")
...
set_para_text(by_idx(54), "1.9. Опыт работы (предпринимательской деятельности) по выбранному направлению: имею профильное техническое образование и наработанный неофициальный опыт участия в отделочных работах в составе ремонтных бригад г. Рязани — точная разметка проёмов лазерным нивелиром, врезка петель и замков по шаблону, установка межкомнатных дверных блоков и раздвижных систем, устройство напольных плинтусов.")
set_para_text(by_idx(55), "1.10. Потребность в обучении/повышении квалификации с обоснованием: потребность в обучении отсутствует. Имеются необходимые практические навыки монтажа межкомнатных и раздвижных дверных систем, скрытых дверных систем Invisible и алюминиевых теневых плинтусов.")
...
set_para_text(by_idx(60), "1.15. Месторасположение: г. Рязань, ул. Московская, д. 35. Деятельность носит выездной характер. Для транспортировки оборудования и выезда на объекты имеется легковой автомобиль. Хранение инструмента, прецизионной оснастки и расходных материалов осуществляется в имеющемся в собственности гараже рядом с домом, аренда отдельного помещения не требуется.")
...
RISKS = [
    ("Снижение платежеспособности потребителей", "Низкая",
     "Гибкая ценовая политика и пакетные предложения."),
    ("Эпидемиологическая обстановка. Риск заболеваемости", "Низкая",
     "Соблюдение санитарных норм и средств индивидуальной защиты."),
    ("Уменьшение потока клиентов (сезонность)", "Низкая",
     "Смещение фокуса в межсезонье на коммерческие помещения."),
    ("Несоответствие ожиданиям клиента", "Низкая",
     "Согласование контрольных точек и фотоотчёт «до/после»."),
    ("Болезнь", "Низкая",
     "Поддержание здорового образа жизни."),
    ("Появление конкурентов", "Средняя",
     "Повышение качества услуг и расширение портфолио."),
    ("Поломка оборудования", "Низкая",
     "Регулярное ТО и хранение в защитных кейсах."),
]
t8 = by_idx(115)
